import {Image, ImagePreview, Layout, Popover, Space, Table, Typography} from "@douyinfe/semi-ui";
...
const Overview: FC = () => {
  const [passport, setPassport] =
    useState<{ iso: string; name: string; ms: number; rank: number; irank: number }[]>();
    ...
    <Layout>
      <Header>
        ...
        <Space vertical align={"center"} style={{width: '100%'}}>
          ...
          <Typography.Text type="tertiary">Find your Passport. Explore them all.</Typography.Text>
        </Space>
      </Header>
      <Content>
        <ImagePreview
